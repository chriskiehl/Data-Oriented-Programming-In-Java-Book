...
//    static Optional<CaseStage2> mergeCaseStage(Optional<CaseStage2> left, Optional<CaseStage2> right) {
//        if (left.isPresent() && right.isPresent()) {
//            if (impact1(left.get()).equals(impact1(right.get()))) {
//                return left.get().name().compareTo(right.get().name()) >= 0
//                        ? left
//                        : right;
//            } else {
//                return impact1(left.get()).equals(Sketch.CustomerImpact.FAVORS)
//                        ? left
//                        : right;
//            }
//        } else {
...
//        List<Row> ys = List.of(
//                new Row("1", Optional.of(CaseStage2.FOO), Optional.of(Sketch.RootCause.DISPUTE), Optional.of(false)),
//                new Row("1", Optional.of(CaseStage2.FOO), Optional.of(Sketch.RootCause.DISPUTE), Optional.of(false))
//        );
//
...
//    }
//
//    static Sketch.CustomerImpact impact1(CaseStage2 stage) {
//        return switch (stage) {
//            case FOO -> Sketch.CustomerImpact.HARMS;
//            case BAR -> Sketch.CustomerImpact.FAVORS;
//        };
//    }
//    static Sketch.CustomerImpact impact2(Sketch.RootCause stage) {
//        return switch (stage) {
//            case TAX, DISPUTE -> Sketch.CustomerImpact.FAVORS;
//            case SUSPENSION -> Sketch.CustomerImpact.HARMS;
//        };
//    }
//
...
//        Result.Winner<A> choose(A x, A y);
//    }
//
//    @FunctionalInterface
//    interface Choice<A> {
...
//        return impact1(stage).equals(Sketch.CustomerImpact.FAVORS);
//    }
//    static boolean noCustomerImpact2(Sketch.RootCause stage) {
//        return impact2(stage).equals(Sketch.CustomerImpact.FAVORS);
//    }
//
//    static Decision<Optional<CaseStage2>> merge = withOptional(considering(Option5::noCustomerImpact)
//            .andThen(considering(Option5::noCustomerImpact))
//            .andFinally(decidingBy(CaseStage2::name)));
//    static Decision<Optional<Sketch.RootCause>> merge2 = withOptional(considering(Option5::noCustomerImpact2)
//            .andFinally(decidingBy(Sketch.RootCause::name)));
