...
import static dop.chapter05.the.existing.world.Repositories.CustomerRepo;
import static dop.chapter05.the.existing.world.Services.ApprovalsAPI;
import static dop.chapter05.the.existing.world.Services.ApprovalsAPI.ApprovalStatus;
import static dop.chapter05.the.existing.world.Services.ContractsAPI;
...
public class Listing5_51 {
    ...
    class StorageFacade {                 // ◄── This façade ties together a whole host of storage and service calls
        ...
        private EnrichedCustomer enrich(Customer customer) { // ◄── This one method keeps so much noise out of the rest of our application.
            ...
            Optional<Approval> approval = Objects.isNull(approvalId)
                    ? Optional.empty()
